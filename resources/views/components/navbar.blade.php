        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
                ...
                <div class="flex space-x-9 mt-8">
                    ...
                    <div class="flex max-w-sm bg-blue-100 rounded-lg shadow-md p-4 items-center">
                        ...
                        <div>
                            <svg class="w-12 h-12 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422A12.083 12.083 0 0118 20.75M6 8.334a12.083 12.083 0 01.84-3.755L12 14z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 20.75c0-.653.097-1.284.278-1.878L12 14v6.75M6 20.75A12.083 12.083 0 0112 14" />
                            </svg>
                        </div>
                    </div>
                    <!-- Card 2 -->
                    ...
                    <div class="flex max-w-sm bg-blue-200 rounded-lg shadow-md p-4 items-center">
                        ...
                        <div>
                            <svg class="w-12 h-12 text-blue-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422A12.083 12.083 0 0118 20.75M6 8.334a12.083 12.083 0 01.84-3.755L12 14z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 20.75c0-.653.097-1.284.278-1.878L12 14v6.75M6 20.75A12.083 12.083 0 0112 14" />
                            </svg>
            ...
            <div class="p-6 bg-white border-b border-gray-200 rounded-lg shadow-sm">
              ...
              <div class="container mx-auto px-4 py-8">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div id="calendar" class="grid grid-cols-7 gap-4 mt-4 text-center text-gray-700"></div>
                </div>
            </div>
